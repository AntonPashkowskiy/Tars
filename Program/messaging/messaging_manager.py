...
class MessagingManagerBackgroudReciever(Thread):
    def __init__(self, messaging_manager_type, send_queue, recieve_queue, stop_event):
        ...
        bind_socket_to_address(self._socket, messaging_manager_type, get_socket_binding_address())
...
class MessagingManager(MessagingInterface):
    def __init__(self, messaging_manager_type):
        ...
        self._background_worker = MessagingManagerBackgroudReciever(messaging_manager_type, \
            self._send_queue, self._recieve_queue, self._background_worker_stop_event)
